...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 03 2017 г., 21:56
...
('def', 'labwork6', 'comments', 'id_comments', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'labwork6', 'comments', 'Text', 2, NULL, 'NO', 'varchar', 250, 750, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(250)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'comments', 'Name', 3, NULL, 'NO', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'comments', 'id_product', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'private_message', 'id_message', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'labwork6', 'private_message', 'id_send', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'private_message', 'id_inbox', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'private_message', 'text', 4, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'private_message', 'subject', 5, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'private_message', 'time', 6, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'private_message', 'status', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'shop', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'labwork6', 'shop', 'img', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'shop', 'name', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'shop', 'diagonal', 4, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'shop', 'price', 5, NULL, 'NO', 'decimal', NULL, NULL, 10, 0, NULL, NULL, 'decimal(10,0)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'shop', 'cuntry', 6, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'shop', 'section', 7, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'labwork6', 'users', 'login', 2, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'users', 'password', 3, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'users', 'email', 4, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'users', 'date_registr', 5, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'labwork6', 'users', 'acces', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
...
('def', 'phone', 'phone', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'phone', 'phone', 'imaged', 2, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'phone', 'named', 3, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'phone', 'diagonal', 4, NULL, 'NO', 'decimal', NULL, NULL, 10, 0, NULL, NULL, 'decimal(10,0)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'phone', 'price', 5, NULL, 'NO', 'decimal', NULL, NULL, 10, 0, NULL, NULL, 'decimal(10,0)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'phone', 'section', 6, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'phone', 'Color', 7, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'phone', 'Country', 8, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'reviews', 'id_reviews', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'phone', 'reviews', 'Text', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'reviews', 'Name', 3, NULL, 'NO', 'varchar', 8, 24, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(8)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'reviews', 'id_product', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'phone', 'reviews', 'Date', 5, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
('def', 'test', 'test', 'comments', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '1711'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '1630'),
('INNODB_BUFFER_POOL_PAGES_DATA', '387'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '1'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7805'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '4094'),
('INNODB_BUFFER_POOL_READS', '388'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '7061'),
('UPTIME_SINCE_FLUSH_STATUS', '7061');
...
('PID_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\LAPTOP-EP8RQPF8.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\LAPTOP-EP8RQPF8.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'Z:\\usr\\local\\mysql-5.5\\data\\LAPTOP-EP8RQPF8.err'),
...
('SLOW_QUERY_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\LAPTOP-EP8RQPF8-slow.log'),
...
('def', 'labwork6', 'PRIMARY', 'def', 'labwork6', 'comments', 'id_comments', 1, NULL, NULL, NULL, NULL),
('def', 'labwork6', 'PRIMARY', 'def', 'labwork6', 'private_message', 'id_message', 1, NULL, NULL, NULL, NULL),
('def', 'labwork6', 'PRIMARY', 'def', 'labwork6', 'shop', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'labwork6', 'PRIMARY', 'def', 'labwork6', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'phone', 'PRIMARY', 'def', 'phone', 'phone', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'phone', 'PRIMARY', 'def', 'phone', 'reviews', 'id_reviews', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2017-04-03 17:56:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-04-03 17:56:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2017-04-03 17:56:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:36', '2017-04-03 17:56:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-03 17:56:37', '2017-04-03 17:56:37', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-04-03 17:56:37', NULL, NULL, NULL, '', '', NULL),
('def', 'labwork6', 'comments', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 0, '2017-03-01 08:25:05', NULL, NULL, NULL, '', '', NULL),
('def', 'labwork6', 'private_message', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 1260, 16384, NULL, 0, 0, '2017-03-03 13:11:51', NULL, NULL, NULL, '', '', NULL),
('def', 'labwork6', 'shop', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 0, '2017-02-28 17:39:36', NULL, NULL, NULL, '', '', NULL),
('def', 'labwork6', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2017-02-27 20:56:47', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-05-15 12:23:04', '2017-02-22 11:50:54', '2012-05-15 12:23:07', NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2017-03-24 12:09:14', NULL, NULL, '', '', NULL),
...
('def', 'phone', 'phone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 0, 0, '2017-02-22 23:42:08', NULL, NULL, NULL, '', '', NULL),
('def', 'phone', 'reviews', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19, 862, 16384, NULL, 0, 0, '2017-02-23 10:59:08', NULL, NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 260, 260, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2017-03-29 06:45:45', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 76, 228, 281474976710655, 7168, 0, '2012-06-11 22:55:25', '2017-03-03 13:13:26', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2017-01-07 18:22:07', NULL, NULL, '', '', NULL),
('def', 'test', 'test', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-01-07 18:34:49', NULL, NULL, NULL, '', '', NULL);
...
(15, 'root', 'localhost:52338', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(14, 'root', 'localhost:52337', NULL, 'Sleep', 3, '', NULL);
...
('def', 'labwork6', 'utf8', 'utf8_general_ci', NULL),
('def', 'mysql', 'utf8', 'utf8_general_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'phone', 'utf8', 'utf8_general_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '4332'),
...
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '10719232'),
('INNODB_DATA_READS', '531'),
('INNODB_DATA_WRITES', '7'),
('INNODB_DATA_WRITTEN', '35328'),
('INNODB_DBLWR_PAGES_WRITTEN', '1'),
('INNODB_DBLWR_WRITES', '1'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '7062'),
('UPTIME_SINCE_FLUSH_STATUS', '7062');
...
('def', 'labwork6', 'comments', 0, 'labwork6', 'PRIMARY', 1, 'id_comments', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'labwork6', 'private_message', 0, 'labwork6', 'PRIMARY', 1, 'id_message', 'A', 13, NULL, NULL, '', 'BTREE', '', ''),
('def', 'labwork6', 'shop', 0, 'labwork6', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'labwork6', 'users', 0, 'labwork6', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'phone', 'phone', 0, 'phone', 'PRIMARY', 1, 'id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'phone', 'reviews', 0, 'phone', 'PRIMARY', 1, 'id_reviews', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', 0, 'phpmyadmin', 'PRIMARY', 3, 'table_name', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-03 17:56:38', '2017-04-03 17:56:38', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-04-03 17:56:38', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'labwork6', 'comments', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 6291456, 13, '2017-03-01 08:25:05', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'labwork6', 'private_message', 'BASE TABLE', 'InnoDB', 10, 'Compact', 13, 1260, 16384, 0, 0, 6291456, 25, '2017-03-03 13:11:51', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'labwork6', 'shop', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 6291456, 15, '2017-02-28 17:39:36', NULL, NULL, 'utf8_general_ci', NULL, '', 'Товары(телефоны)'),
('def', 'labwork6', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 6291456, 5, '2017-02-27 20:56:47', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-05-15 12:23:04', '2017-02-22 11:50:54', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'Database privileges'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2017-03-24 12:09:14', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phone', 'phone', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 0, 6291456, NULL, '2017-02-22 23:42:08', NULL, NULL, 'utf8_general_ci', NULL, '', 'Телефоны'),
('def', 'phone', 'reviews', 'BASE TABLE', 'InnoDB', 10, 'Compact', 19, 862, 16384, 0, 0, 6291456, 125, '2017-02-23 10:59:08', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 260, 260, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2017-03-29 06:45:45', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 76, 228, 281474976710655, 7168, 0, NULL, '2012-06-11 22:55:25', '2017-03-03 13:13:26', NULL, 'utf8_bin', NULL, '', 'Tables'' UI preferences'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2017-01-07 18:22:07', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin'),
('def', 'test', 'test', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 6291456, NULL, '2017-01-07 18:34:49', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'labwork6', 'PRIMARY', 'labwork6', 'comments', 'PRIMARY KEY'),
('def', 'labwork6', 'PRIMARY', 'labwork6', 'private_message', 'PRIMARY KEY'),
('def', 'labwork6', 'PRIMARY', 'labwork6', 'shop', 'PRIMARY KEY'),
('def', 'labwork6', 'PRIMARY', 'labwork6', 'users', 'PRIMARY KEY'),
...
('def', 'phone', 'PRIMARY', 'phone', 'phone', 'PRIMARY KEY'),
('def', 'phone', 'PRIMARY', 'phone', 'reviews', 'PRIMARY KEY'),
...
--
-- База данных: `labwork6`
--
CREATE DATABASE `labwork6` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `labwork6`;
...
INSERT INTO `comments` (`id_comments`, `Text`, `Name`, `id_product`) VALUES
(0, 'Просто супер', 'Рома', 2),
(1, 'Телефон отличный', 'Андрей', 1),
(4, 'Покупаю телефон', 'Роман', 0),
(6, '1', '1', 0),
(7, 'Андрей', 'Купил товар', 9),
(8, 'Покупка прошла успешно', 'Василий', 9),
(9, 'Телефон очень хороший, советую многим!', 'Кирилл', 5),
(10, 'Качество выше всего, советую', 'Дима', 0),
(11, 'Отличный смартфон пользуюсь ним уже две недели,очень радует камера,и производительность смартфона..по батарее вообще супер,стабильно держит день батарею при средних нагрузках..а дизайн просто космос,хорошо лежит в руке,не скользит и не выпадает\n', 'Владимир', 0),
(12, 'хорош)))', 'Дмитрий', 14);

-- --------------------------------------------------------

--
-- Структура таблицы `private_message`
--
...
--
-- Дамп данных таблицы `private_message`
--

INSERT INTO `private_message` (`id_message`, `id_send`, `id_inbox`, `text`, `subject`, `time`, `status`) VALUES
(12, 2, 3, 'Тестирую сайт) надеюсь отправка будет)', 'Привет друг', '2017-03-03 12:37:00', 0),
(13, 2, 3, 'Тестирую сайт) надеюсь отправка будет)', 'Привет друг', '2017-03-03 12:40:00', 0),
(14, 2, 0, '1', '1', '2017-03-03 12:40:00', 1),
(15, 2, 0, '1', '1', '2017-03-03 12:40:00', 1),
(16, 2, 2, 'user', 'user', '2017-03-03 12:42:00', 0),
(17, 2, 3, 'Привет) тестирую вот, получилось похожу', 'Привет', '2017-03-03 16:09:00', 1),
(18, 2, 3, 'Привет, работат или нет ?', 'Проверка', '2017-03-03 16:13:09', 1),
(19, 2, 3, 'Проверяем работу сайта!', 'Проверка', '2017-03-03 16:22:14', 0),
(20, 2, 3, 'pereday sokolovu lesha', 'roma privet', '2017-03-06 13:46:55', 0),
(21, 3, 2, 'horoosho!', 'Re: roma privet', '2017-03-06 13:47:17', 0),
(22, 5, 3, '123', 'test', '2017-03-29 10:46:48', 0),
(23, 3, 2, 'Привет, проверка', 'rerer', '2017-03-29 22:40:07', 0),
(24, 2, 3, 'уцкуцкуц', 'Re: rerer', '2017-03-29 22:40:35', 0);
...
CREATE TABLE IF NOT EXISTS `shop` (
  ...
  `cuntry` varchar(10) NOT NULL,
  `section` varchar(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Товары(телефоны)' AUTO_INCREMENT=15 ;

--
-- Дамп данных таблицы `shop`
--

INSERT INTO `shop` (`id`, `img`, `name`, `diagonal`, `price`, `cuntry`, `section`) VALUES
(0, 'http://test1.ru/resource/images/shops/lenovo.jpg', 'Lenovo P70', '5.9', '235', 'China', 'lenovo'),
(2, 'http://test1.ru/resource/images/shops/samsung.jpg', 'Samsung', '5', '274', 'USA', 'samsung'),
(3, 'http://test1.ru/resource/images/shops/xiomi-redmi.jpg', 'Xiomi Redmi Pro 3', '6.0', '389', 'China', 'xiomi'),
(4, 'http://test1.ru/resource/images/shops/meizu-mx5.jpg', 'Meizu Pro 5', '5.3', '450', 'China', 'meizu'),
(5, 'http://test1.ru/resource/images/shops/meizu-m3.jpg', 'Meizu M3 Note', '5.2', '375', 'China', 'meizu'),
(6, 'http://test1.ru/resource/images/shops/meizu-u10.jpg', 'Meizu U10', '5.0', '250', 'China', 'meizu'),
(7, 'http://test1.ru/resource/images/shops/samsung-s7.jpg', 'Samsung Galaxy S7', '5.1', '855', 'China', 'samsung'),
(8, 'http://test1.ru/resource/images/shops/iphone5s.jpg', 'Iphone 5S', '4.0', '300', 'USA', 'iphone'),
(9, 'http://test1.ru/resource/images/shops/samsung-a5.jpg', 'Samsung Galaxy A5', '5.3', '250', 'China', 'samsung'),
(14, 'http://test1.ru/resource/images/shops/dimapro.jpg', 'Dima Pro 5', '1.5', '15', 'Hohol', '');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `date_registr` varchar(30) NOT NULL,
...
INSERT INTO `users` (`id`, `login`, `password`, `email`, `date_registr`, `acces`) VALUES
(0, 'testim', 'e177ec99c317aeb970663eac961cc03a', 'test@mail.ru', '2017-02-27 20:19', 2),
(2, 'user', 'd1739ad08d06f89f02bdaddbf426a640', 'user@mail.ru', '2017-02-28 12:57', 2),
(3, 'roma', '116fd1d25db0d283c1124f2c8ea00aea', '123@mail.ru', '2017-03-01 11:32', 1),
(4, 'bogdan', '710c4d79965e4209e5fcbcf4850f1b2c', 'bogdan@mail.ru', '2017-03-01 11:59', 1);
--
-- База данных: `mysql`
--
...
-- База данных: `phone`
--
CREATE DATABASE `phone` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `phone`;
...
CREATE TABLE IF NOT EXISTS `phone` (
  `id` int(10) NOT NULL,
  `imaged` varchar(25) NOT NULL,
  `named` varchar(10) NOT NULL,
  `diagonal` decimal(10,0) NOT NULL,
  `price` decimal(10,0) NOT NULL,
  `section` varchar(10) NOT NULL,
  `Color` varchar(10) NOT NULL,
  `Country` varchar(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Телефоны';

--
-- Дамп данных таблицы `phone`
--

INSERT INTO `phone` (`id`, `imaged`, `named`, `diagonal`, `price`, `section`, `Color`, `Country`) VALUES
(0, 'img/tovars/apple.jpg', 'Iphone', '6', '1239', 'Iphone', 'White', 'USA'),
(1, 'img/tovars/lenovo.jpg', 'Lenovo', '5', '230', 'Lenovo', 'Yellow', 'China'),
(2, 'img/tovars/samsung.jpg', 'Samsung', '5', '274', 'Samsung', 'White', 'Tailand'),
(3, 'img/tovars/xiomi.jpg', 'Xiomi Redm', '6', '389', 'Xiomi', 'Black', 'China'),
(4, 'img/tovars/meizu.jpg', 'Meizu Pro ', '5', '450', 'Meizu', 'White', 'Korea'),
(5, 'img/tovars/meizu-m3.jpg', 'Meizu M3 N', '5', '375', 'Meizu', 'Black', 'Korea'),
(6, 'img/tovars/meizu-u10.jpg', 'Meizu U10', '5', '255', 'Meizu', 'White', 'Korea'),
(7, 'img/tovars/samsung-s7.jpg', 'Samsung Ga', '5', '855', 'Samsung', 'Red', 'Tailand'),
(8, 'img/tovars/samsung-a5.jpg', 'Samsung Ga', '5', '255', 'Samsung', 'White', 'Tailand');
...
INSERT INTO `reviews` (`id_reviews`, `Text`, `Name`, `id_product`, `Date`) VALUES
(0, 'good provider', 'Roman', 0, '2017-02-23 13:56'),
(1, 'Thank!!', 'Oleg', 1, '2017-02-23 13:57'),
(2, 'Good tovar', 'Tanya', 2, '2017-02-23 13:58'),
(109, 'Спасибо,товар хороший!', 'Андрей', 2, '2017-02-23 14:21'),
(110, 'Ух ты, супер просто.', 'Роман', 7, '2017-02-23 14:21'),
(111, 'Впервые вижу такой классный товар.', 'Андрей', 8, '2017-02-23 14:21'),
(112, 'Спасибо дррузья! купил классный телефон', 'Андрюха', 1, '2017-02-23 14:21'),
(113, 'Не берите! товар плохой!', 'Соколов', 0, '2017-02-23 14:22'),
(114, 'Ну такое, видел и лучше', 'Дима', 4, '2017-02-23 14:22'),
(115, 'Спасибо, понравился', 'Кирилл', 5, '2017-02-23 14:22'),
(116, 'не очень', 'Растисла', 6, '2017-02-23 14:22'),
(117, 'Редми купил телефон получил', 'Али', 3, '2017-02-23 14:23'),
(118, 'я купил телефон, спасибо, понравился', 'Кирилл', 3, '2017-02-23 14:26'),
(119, 'tovar horoshiyy', 'Kirill', 2, '2017-02-23 17:35'),
(120, 'классный телефон , спасибо', 'Дима', 0, '2017-02-23 19:46'),
(121, 'Текст', 'Андрей', 0, '2017-02-24 14:12'),
(122, 'Текст', 'Имя', 2, '2017-02-24 14:18'),
(123, 'текст', 'Имя', 2, '2017-02-24 14:18'),
(124, 'текст', 'Имя', 2, '2017-02-24 14:20');
--
...
('root', '[{"db":"labwork6","table":"users"},{"db":"labwork6","table":"private_message"},{"db":"phone","table":"reviews"},{"db":"labwork6","table":"shop"},{"db":"labwork6","table":"comments"},{"db":"phone","table":"phone"},{"db":"test","table":"comments"}]');
...
('root', 'phone', 'phone', '[]', '2017-02-22 19:05:14'),
('root', 'phone', 'reviews', '{"sorted_col":"`reviews`.`id_reviews` ASC"}', '2017-02-23 08:46:02'),
('root', 'labwork6', 'private_message', '{"sorted_col":"`private_message`.`time` DESC"}', '2017-03-03 12:13:26');
...
('root', '2017-01-07 17:21:12', '{"lang":"ru"}');
--
-- База данных: `test`
--
